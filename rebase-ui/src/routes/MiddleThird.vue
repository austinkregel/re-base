<template>
  <div class="flex flex-wrap h-screen font-mono text-base">
    ...
    <div  v-if="openContext && openForFile">
      ...
      <div class="absolute z-10 mt-2 w-56 overflow-hidden rounded-md shadow-lg bg-neutral-600 ring-1 ring-black ring-opacity-5 focus:outline-none" role="menu" aria-orientation="vertical" aria-labelledby="menu-button" tabindex="-1"
